...
urlpatterns = [
    ...
    url(r'^blog/detail/(?P<article_id>\d+)$', views.ArticleDetailView.as_view(), name='detail'),
    ...
    url(r'^blog/comment/(?P<article_id>\d+)', views.CommentPostView.as_view(), name='comment')
]
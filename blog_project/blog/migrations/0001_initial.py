# -*- coding: utf-8 -*-
# Generated by Django 1.10.5 on 2017-01-15 03:05
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('last_modified_time', models.DateTimeField(auto_now=True, verbose_name='\u521b\u5efa\u65f6\u95f4')),
                ('status', models.CharField(choices=[('d', 'Draft'), ('p', 'Published')], max_length=1, verbose_name='\u6587\u7ae0\u72b6\u6001')),
                ('abstract', models.CharField(blank=True, help_text='\u53ef\u9009\uff0c\u5982\u4e3a\u7a7a\u5219\u53d6\u6b63\u6587\u524d54\u4e2a\u5b57\u7b26', max_length=54, null=True, verbose_name='\u6458\u8981')),
